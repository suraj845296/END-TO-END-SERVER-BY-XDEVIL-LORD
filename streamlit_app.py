...
<style>
    ...
    * {
    ...
    .stApp::before {
        ...
        right: 0;
        bottom: 0;
        background: url('https://i.ibb.co/Mk4n3Zh4/cccf21694e054d66aa5a945bb3b212fa.jpg');
        background-size: cover;
        background-position: center;
        opacity: 0.1;
        z-index: -1;
    ...
    .main-header h1 {
        background: linear-gradient(45deg, #4ecdc4, #667eea, #4ecdc4);
    ...
    /* Enhanced input fields with blue theme */
    ...
    .stNumberInput>div>div>input:focus {
        ...
        box-shadow: 0 0 0 3px rgba(78, 205, 196, 0.3), inset 0 2px 10px rgba(0, 0, 0, 0.3) !important;
    ...
    .stTextArea>div>div>textarea::placeholder {
        color: rgba(180, 200, 255, 0.7) !important;
        font-weight: 400 !important;
    }
    
    /* Make sure the text inside inputs is clearly visible */
    ...
    .stTabs [aria-selected="true"] {
        background: linear-gradient(45deg, #667eea, #4ecdc4) !important;
    ...
    .console-output {
        ...
        scrollbar-color: rgba(78, 205, 196, 0.6) rgba(0, 0, 0, 0.3);
...
document.addEventListener('DOMContentLoaded', function() {
    ...
    document.querySelector('.stApp').appendChild(rainContainer);
