    ...
    * {{
    ...
    @keyframes dynamicGlow {{
        ...
        42% {{
            ...
            border-image: linear-gradient(45deg, #ff9ff3, #a29bfe) 1;
        }}
        56% {{
            box-shadow: 0 0 10px #a29bfe, 0 0 20px #a29bfe, 0 0 30px #a29bfe;
            border-image: linear-gradient(45deg, #a29bfe, #55efc4) 1;
        }}
        70% {{
            box-shadow: 0 0 10px #55efc4, 0 0 20px #55efc4, 0 0 30px #55efc4;
            border-image: linear-gradient(45deg, #55efc4, #fd79a8) 1;
        }}
        84% {{
            box-shadow: 0 0 10px #fd79a8, 0 0 20px #fd79a8, 0 0 30px #fd79a8;
            border-image: linear-gradient(45deg, #fd79a8, #ffeaa7) 1;
        }}
        100% {{
            box-shadow: 0 0 15px #ffeaa7, 0 0 25px #ffeaa7, 0 0 35px #ffeaa7;
            border-image: linear-gradient(45deg, #ffeaa7, #ff6b6b) 1;
        }}
    }}
...
if st.session_state.admin_logged_in:
    ...
    if st.session_state.approval_status != 'approved':
        ...
        <div class="approval-box">
            ...
            <p><strong>Your Approval Key:</strong> <code>{st.session_state.approval_key}</code></p>
        </div>
        """, unsafe_allow_html=True)
